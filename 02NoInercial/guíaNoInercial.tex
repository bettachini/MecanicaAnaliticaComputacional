...
El perno $B$ está engarzado tanto en su guía recta, a una distancia $P$ del punto en torno al que gira con libertad, así como a una guía circular de radio $R$.
El conjunto rota en torno al eje de simetría, línea discontinua horizontal en el croquis, con velocidad angular constante $\omega$.

Determine $\dot{\vec{r}}$ y $\ddot{\vec{r}}$ del perno suponiéndolo puntual.
\end{minipage}
\begin{minipage}[c][1cm][t]{0.3\textwidth}
