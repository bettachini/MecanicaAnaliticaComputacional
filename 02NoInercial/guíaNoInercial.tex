...
El perno $B$ está engarzado tanto en su guía recta así como a una guía circular de radio $R$ centrado en $O$.
Esta última está fija, pero la guía recta gira con velocidad angular constante $\omega$ en torno de $A$ ubicado a una distancia $R$ de $O$, a izquierda del mismo en el croquis.
Así desde $A$ el perno está a una distancia $\rho$.
La longitud de la guía recta $\bar{AC}$ habilita que el perno recorra la guía circular entre $D$ y $E$ sin restricciones.

Determine $\dot{\vec{r}}$ y $\ddot{\vec{r}}$ del perno.
\end{minipage}
\begin{minipage}[c][1cm][t]{0.3\textwidth}
	\includegraphics[width=\textwidth]{\detokenize{pernoGuíaDescentrada}}
\end{minipage}
...
¿Cambia este como resultado de la extensión de las barras que soportan los instrumentos?
\medskip
