...
Verifique que recupera el Lagrangiano de un péndulo simple de asumir \(m_1=0\), \(\varphi_1 = \varphi_2 = \varphi\) y \(\ell_1 = \ell_2 = \frac{l}{2}\).
\end{minipage}
...
\end{minipage}
	\begin{minipage}[c][5cm][t]{0.5\textwidth}
