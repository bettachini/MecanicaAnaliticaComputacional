...
\begin{enumerate*}
	\item \includegraphics[height=0.3\textwidth]{marion_fig7_1}
	\item \includegraphics[height=0.3\textwidth]{landauS52_fig2}
	\item \includegraphics[height=0.3\textwidth]{landauS52_fig1}
\end{enumerate*}
