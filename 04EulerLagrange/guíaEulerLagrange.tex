...
\item
	\begin{minipage}[t][4.5cm]{0.7\textwidth}
		...
		Un bloque de masa \(m\) se lo sujeta inmovil sobre un plano de inclinación \(\theta\) que no le presenta fricción y de masa \(M\).
		...
		\begin{enumerate}
			\item Al soltar el bloque más pequeño, ¿que aceleración tiene el plano?
			\item (*) Intente resuelver con la 2.a ley de Newton, \(\vec{F} = m \vec{a}\).
...
\item
	\begin{minipage}[t][5cm]{0.7\textwidth}
		...
		\begin{enumerate}
			\item (*) Ecuentre una ecuación para la dinámica de la distancia de la partícula a la intersección \(d\).
