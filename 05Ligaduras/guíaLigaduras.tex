...
\textbf{Aro y polea}\\
	...
	El otro extremo se atá con un nudo de masa \(M> m\) a un aro de masa \(m_a\), enrollandose parcialmente en torno a este.
	El radio del mismo es \(R\) y puede rotar libremente, lo que hace que este y el nudo presenten momentos de inercia \(m_a R^2\) y \(M R^2\) respectivamente.
	\begin{enumerate}
