...
\begin{enumerate}
	\item \(\ell = \SI{2}{\metre}\), \(\varphi(t=0) = \frac{\pi}{4}\), \(\dot{\varphi}(t=0) = 0\),
	\item \(\ell = \SI{2}{\metre}\), \(x(t=0) = \SI{1}{\metre}\), \(\dot{x}(t=0) = \SI{0.5}{\metre\per\second\squared} \), \(\phi(t=0) = \frac{\pi}{8}\), \(\dot{\phi}(t=0)\),
	\item \(\ell_1 = \SI{1}{\metre}\), \(\phi_1(t=0) = \frac{\pi}{8}\), \(\dot{\phi}_1(t=0)\), \(\ell_2 = \SI{1}{\metre}\), \(\phi_2(t=0) = \frac{\pi}{4}\), \(\dot{\phi}_2(t=0)\).
\end{enumerate}
