...
\begin{frame}
	...
	\begin{block}{Teoría y ejercicios resueltos en linea en cuadernos programables}
		\begin{itemize}[<+->]
			\item Modificando su código se resuelven guías semanales de ejercicios.
			\item Asincrónico: consultas en línea 24/7 \textbf{públicas} hacia otros alumnos.
			\item Cuadernos multi-usuario: resolución en colaboración remota.
			\item Sincrónico: \textbf{docente disponible} al finalizar ejercicios 
			\item Entrega semanal para corrección \textbf{semanal} y \textbf{obligatoria}.
		\end{itemize}
	\end{block}
	\begin{columns}[b]<1->
