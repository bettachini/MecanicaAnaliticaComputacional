...
\begin{figure}[h]
	...
	\caption{Con una línea de código simple se pueden estudiar las curvas equipotenciales resultantes de la intersección de las superficies equipotenciales con planos a diferentes alturas ($z = 0$ y $z = 0.5$) respecto de las cargas.}
    \label{fig:superficies}
\end{figure}

Aprovechando la flexibilidad, Con esta metodología, los estudiantes:
\begin{itemize}
\item repasar lo trabajado en clases previas y adquirir nuevos conceptos sobre campo y potencial eléctrico, trabajando en un mayor número de situaciones, con una respuesta rápida sobre sus intuiciones para el análisis;
