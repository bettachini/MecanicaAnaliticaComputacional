...
\begin{itemize}
    \item proponer la resolución y el análisis de problemas más complejos, que estarían descartados en una clase de pizarrón, aprovechando la sencillez de la reutilización de código;
...
El empleo de recursos tecnológicos durante el proceso de
aprendizaje permite que el estudiante ejecute procedimientos
rutinarios con rapidez y seguridad, posibilitándole así disponer
de más tiempo para internalizar o comprender conceptos.