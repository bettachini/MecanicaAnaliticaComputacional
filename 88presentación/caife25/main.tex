...
\subsection{El código como una herramienta central de una asignatura}
...
Para capitalizar lo aprendido de cálculo numérico en asignaturas precedentes, a los fines de obtener soluciones de las ecuaciones aún de las más complejas ecuaciones integro-diferenciales generadas con auxilio de SymPy, se recurre a la biblioteca SciPy \cite{2020SciPy-NMeth}. Y finalmente, para generar representaciones gráficas de tales resultados, se hace uso de la biblioteca Matplotlib \cite{Hunter:2007}.
...
Por el contrario, se busca que simplemente pueda plasmar una solución apoyándose en código ya escrito y solo aprenda a adaptarlo a sus necesidades.
