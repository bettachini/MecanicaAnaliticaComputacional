...
\subsection{El código es el mejor acople con LLMs que softwares específicos}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{../figuras/flippedClassroomSchedule_castellano.png}
