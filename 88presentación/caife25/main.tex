...
\begin{figure}[ht]
	...
	\caption{
		...
		Por más que se incorporó la computadora a la clase, su sub utilización es evidente cuando se lo emplea para proyectar lo mismo que puede mostrar un pizarrón. 
		}
...
El uso de inteligencia artificial por el ámbito educativo es algo inevitable en el presente y posiblemente sea generalmente aceptado en el futuro.
Las interfaces de conversación (chat) de grandes modelos de lenguaje (LLM) en línea como ChatGPT de OpenAI, DeepSeek, GitHub Copilot o Google Gemini han demostrado ser herramientas útiles a la hora de ayudar a los alumnos a resolver problemas de física.

Los alumnos puede intentar una primera aproximación a la solución de un problema de física planteando un prompt al LLM o incluso ir corrigendo el código que el LLM le sugiere, como muestra el ejemplo de la figura \ref{fig:Gemini}.
...
\begin{figure}[ht]
	...
	\caption{
		...
		Aquí dejó constancia como comentario en el bloque de código del prompt que realizó al LLM Gemini de Google.  
		}
	\label{fig:Gemini}
\end{figure}
