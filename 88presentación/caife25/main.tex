...
En una de mecánica se aplican a asignaturas de mecánica de fluidos, 
<figura de correlativas UNLaM>
En una de electrónica, previo a los primeros cursos de circuitos se trata de explicar el funcionamiento de dispositivos electrónicos discrétos fundamentados en la mecánica cuántica y electrostatica en base a lo visto en asignaturas de física moderna y electromagnetismo.
...
\subsection{Escribir código no es programar ABORDANDO MÁS COMPLEJIDAD}
