...
Pero para una exitosa explotación de esta herramienta en las tempranas asignaturas de una carrera de ingeniería mecánica entendemos que se deben cumplirse dos condiciones.
...
Esta última herramienta creada en el siglo XIX sigue siendo el foco de atención en los siglos subsiguientes, como ilustra la Figura \ref{fig:oldSchool}, algo no distinto de lo que puede verse en un aula contemporánea.
Desde entonces la metodología de la clase se resumen en que el docente presenta un tema con anotaciones en el pizarrón, los alumnos toman apuntes en papel, luego realizan la ejercitación, y el docente corrige, en el mismo medio.
...
En la última década del siglo XX se generalizó el uso de computadoras en el aula por parte de los docentes, aunque usualmente reducidas a la tarea de ser medio de proyección algo que excluye a los alumnos de uso, como muestra la Figura \ref{fig:oldSchool2010}. 
Aun cuando estos últimos realicen sus anotaciones en computadoras portátiles, reproducen aún el mismo esquema del s. XIX, inviertendo buena parte de su tiempo y atención en transcribir lo mostrado en un pizarrón.

Esta sub explotación de inherente capacidad de rápida réproducción de la información digital queda aún más fuera del contexto actual ante la omnipresencia de grandes modelos de lenguaje (LLM) como ChatGPT o DeepSeek, que permiten a los estudiantes obtener una rápida orientación sobre la temática que se está tratando.  
No es viable pretender que puedan escindirse los cursos de ingeniería del uso de LLM.
...
Tal transcripción de sus anotaciones en papel al teléfono o computadora conectadas a internet, sumada al arcaico proceder de tomar apuntes en clase, es sumar es sumar una tarea adicional que distrae al alumo del pensamiento creativo que debiera ser el foco de su esfuerzo.

Por estas razones es que en en nuestro curso se utiliza un único formato digital en línea, sea para el dictado de lecciones por parte del docente, así como para la ejercitación por parte de los alumnos.
Dicho medio debe ser capaz no solo de representar todo el contenido gráfico que puede mostrarse en un pizarrón, sino también de plasmar en ecuaciones integro-diferenciales el sistema físico a analizar, resolverles llevándoles a resultados numéricos y generar representaciones de dichos resultados, idealmente gráficos, para permitir verificarles.
...
Para extender la capacidad del Python para cubrir las necesidades para estas tres tareas específicas se recurre a sendas bibliotecas de Python: SymPy, SciPy y Matplotlib (\cite{sympy}, \cite{2020SciPy-NMeth}, \cite{Hunter:2007}).
...
Haciendo uso del formato de cuadernos Jupyter, como el que muestra la Figura \ref{fig:jupyter}, se intercalan en un mismo documento texto, ecuaciones y gráficos generados en forma externa con aquellos que se producen por el código Python.
...
El curso abordó esta cuestión creado un entorno de aprendizaje en línea y asíncrono que permite a los alumnos estudiar a su propio ritmo mediante el enfoque de aula invertida (flipped classroom) \cite{moraros_flipping_2015} que ilustra la Figura \ref{fig:flippedClassroomSchedule}.

\begin{figure}[ht]
	\centering
	\begin{subfigure}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{../figuras/flippedClassroomSchedule_castellano.png}
	...
	\begin{subfigure}[b]{0.6\textwidth}
		\includegraphics[width=\textwidth]{../figuras/seguimiento.png}
...
\textcolor{red}{ESTO PUEDE SER MENCIONADO EN LA INTRODUCCION no se frustran con integrales que aún no dominan\cite{Pekrun2006}, permitiéndoles resolver más problemas con retroalimentación inmediata, que se traduce en más práctica para la incorporación de conceptos; trabajan en forma autónoma; reutilizan y adaptan código para experimentar con problemas cada vez más complejos, incluso no solo entre los propuestos en esta materia, atesorando una herramienta que podrán aprovechar en otros contextos;}

\textcolor{red}{Producen un conjunto de cuadernos que pueden (o son utilizados, referencia, ¿aunque sea de comentarios de los estudiantes?) ser utilizados en cursos posteriores e incluso en aplicaciones profesionales. }\par\medskip  
