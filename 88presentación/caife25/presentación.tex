...
\begin{frame}
	\frametitle{Mecánica computacional como competencia}
	\begin{block}{Proceso de la mecánica computacional}
		\begin{itemize}
			\item Modelo matemático como simplificación de la realidad.
			\item Ecuaciones diferenciales de esfuerzos y dinámica.
			\item Soluciones numéricas y representaciones gráficas.
		\end{itemize}
	\end{block}
	\pause
