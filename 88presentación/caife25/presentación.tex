...
\begin{frame}[plain] 
  ...
  \end{beamercolorbox}
	...
	\begin{flushleft}
	Relevar al estudiante de cálculos repetitivos extendió el alcance de dos asignaturas:
	\\
	$\bullet$ Modelar esfuerzas y dinámica de dispositivos industriales realistas con la mecánica analítica.\\ 
	  ...
	  \begin{columns}[c]
			...
			\begin{column}{0.7\textwidth}
				\begin{itemize}[<+->]
					...
					\item Aburrimiento \(\implies \downarrow\) interés en la asignatura
				\end{itemize}
			\end{column}
		\end{columns}
	\end{block}
	  ...
	  \begin{columns}[c]
			...
			\begin{column}{0.7\textwidth}
				\begin{itemize}[<+->]
					...
					\item \textbf{Recicla} código para resolver nuevos problemas
				\end{itemize}
			\end{column}
		\end{columns}
	\end{block}
