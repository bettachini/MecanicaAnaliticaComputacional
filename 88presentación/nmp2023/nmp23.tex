...
\date[2023-11-23]{
	...
	21-24 november 2023\\
	\includegraphics[height= 0.05\textwidth]{logos}
...
\begin{frame}
	...
	\uncover<3->{\includegraphics[height= 2.5 cm]{hard}}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= \textwidth]{clase7esquema.png}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	\frametitle{Tools | 8th class | GitHub Copilot: AI assistance in coding}
	% \pause
	%Class 7: Adding complexity
	\begin{block}{}
		\begin{itemize}
			\item Once students grasp the basics they're invited to take advantage of AI
			\item After commenting in plain text what they need, GitHub Copilot suggests code   
			%\item Gradual increase in complexity of simulated mechanical devices.
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
...
\begin{frame}
	...
	% \begin{block}{New theory alongisde its worked examples in programmable notebooks}
		\begin{itemize}[<+->]
			...
			\item On-line 24/7 \textbf{asynchronical} consultations that are \textbf{public} to other students
			\item \textbf{synchronical} meetings with TA's to finish assignments
...
%\begin{frame}
	...
	%\begin{block}{}
		...
		%\end{description}
	%\end{block}
	%\uncover<6->{\includegraphics[height= 3.5cm]{cuñaAnillosN}}
	%\uncover<7->{\includegraphics[height= 3.5cm]{copilot}}
%\end{frame}
