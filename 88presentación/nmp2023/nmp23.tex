...
\begin{frame}
	...
	\includegraphics[width= 0.7\textwidth]{comentariosColab}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= 0.7\textwidth]{repositorioGithub}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= 0.7\textwidth]{clase3sympy}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	...
	\begin{block}{}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= 0.7\textwidth]{clase5EulerLagrange.png}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= 0.7\textwidth]{clase4Aceleraciones}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= 0.7\textwidth]{clase5Soluciones.png}
	\end{block}
	% \pause
\end{frame}
...
\begin{frame}
	...
	\begin{block}{}
		...
		\end{itemize}
		% \uncover<4->{\includegraphics[height= 2cm]{ucarecdn}}
	\includegraphics[width= 0.7\textwidth]{clase7esquema.png}
	\end{block}
	% \pause
\end{frame}
